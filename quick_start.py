...
🧪 测试:
    5. 测试对话功能          (python -m pytest tests/test_chat.py)
    6. 测试交叉注意力        (python -m pytest tests/test_cross_attention.py)

📖 文档:
    7. 显示聊天指南          (cat docs/CHAT_GUIDE.md)
    8. 显示数据指南          (cat docs/DATA_GUIDE.md)
    9. 显示快速开始指南      (cat docs/QUICK_START.md)
    10. 显示项目文档         (cat docs/README.md)
...
def main():
    ...
    scripts = {
        ...
        '6': 'tests/test_cross_attention.py',
        '7': 'docs/CHAT_GUIDE.md',
        '8': 'docs/DATA_GUIDE.md',
    ...
    while True:
        show_menu()
        choice = input("请选择 (1-10 或 q 退出): ").strip().lower()
